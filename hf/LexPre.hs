...
type PosTokenPre = (ByteString,Pos,Int,Lex)
                -- filename, position, column, lexem
                -- column is that of position start
                -- repeated here for easy access

lexPre :: Bool -> ByteString -> String -> [PosTokenPre]
lexPre u file l = iPreLex u file 1 1 l

------- local

iPreLex :: Bool -> ByteString -> Int -> Int -> String -> [PosTokenPre]
            ...
            case words line of
              ("line":line:file:_) | all isDigit line ->
                case lexInteger 10 0 line of
                  (_,r,_) ->
                      iPreLex u (pack file) (fromInteger r) 1 (tail xs)
...
skipcomment :: Bool -> ByteString ->Int ->Int ->Int ->String ->[PosTokenPre]
