...
:: P = Sym Int | Neg P | Con P P | Dis P P;
...
invTaut (Pair c a) = null (inter (==) c a);
...
union eq xs ys = append xs (filter (comp inv (contains eq xs)) ys);
