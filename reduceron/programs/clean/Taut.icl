...
:: Prop = Const Bool | Var Int | Not Prop
  | And Prop Prop | Implies Prop Prop;
...
imp v = Implies (Var (char 'q')) (Var v) ;

names = str "abcdefghijklmnop" ;

testProp = Implies
             (foldr1 And (map imp names))
             (Implies (Var (char 'q')) (foldr1 And (map Var names))) ;

Start = case isTaut testProp of {
       True  -> 1 ;
       False -> 0 ;
       } ;
