...
// This version expects the spine of a combinator body to come first
// rather than last.

//#define STACK_SIZE 1114096
//#define HEAP_SIZE 111132767
//#define CODE_SIZE 1114096
...
int main(int argc, char *argv[])
{
  ...
  printf("REMEMBER: Will crash if AP-nodes have not been reversed!\n");
