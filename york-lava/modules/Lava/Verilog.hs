...
ramFile part name ramType params = undefined
...
gate n str params comp inps =
  compStr comp ++ " : " ++ str ++ "(" ++ argList (xs ++ ys) ++ ");\n"
...
delay "fd" params comp inps =
  "  always @(posedge clock) "
  ++ wireStr (comp, 0)
  ++ " <= "
  ++ (wireStr $ head $ tail inps)
  ++ ";\n"
